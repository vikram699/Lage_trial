...
public class TC_CreateTicket extends BaseClass{
	...
	public void createTicket(Hashtable<String,String> data) throws InterruptedException {
		if (!data.get("RunMode").equalsIgnoreCase("N")){
			test.createNode(data.get("os")+" "+data.get("browser"));

			SalesPage page = new SalesPage(Constants.BadgerObjectRepository, test);
			page
